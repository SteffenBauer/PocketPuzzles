...
static config_item *get_prefs(game_ui *ui)
{
    ...
    ret[PREF_CLICK_ACTIONS].u.choices.choicenames = ":Fill/Circle:Circle/Fill";
    ret[PREF_CLICK_ACTIONS].u.choices.choicekws = ":fill:dot";
    ret[PREF_CLICK_ACTIONS].u.choices.selected = ui->swap_buttons;

    ret[PREF_BLACK_NUMS].name = "Show numbers on black squares";
    ret[PREF_BLACK_NUMS].kw = "show-black-nums";
    ret[PREF_BLACK_NUMS].type = C_BOOLEAN;
    ret[PREF_BLACK_NUMS].u.boolean.bval = ui->show_black_nums;
...
static void set_prefs(game_ui *ui, const config_item *cfg)
{
    ...
    ui->show_black_nums = cfg[PREF_BLACK_NUMS].u.boolean.bval;
}
